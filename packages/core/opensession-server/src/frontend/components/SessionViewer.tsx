...
export function SessionViewer({
  ...
  const {
    dismissKey: shareDismissKey,
    dismissed: shareDismissed,
    setDismissed: setShareDismissed,
  } = shippedShareState;
  ...
  const { uploads, uploadStaging } = composerDraft.attachments;
  const {
    dragDepthRef,
    fileDragPresentRef,
  ...
  const { draggingQueueRef, pendingReorderRef } = useComposerQueueState();
  ...
  const addSessionAttachments = useSessionAttachmentDrop({
