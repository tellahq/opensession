...
export const composerTextareaPaddingMinimized = utilityClassName("px-1 py-0");
...
export const composerToolbarMinimized = utilityClassName("contents");
...
export const composerMenuWidth = utilityClassName("min-w-[172px]");
/** Default anchoring: the menu hangs off the right edge of its trigger. */
export const composerMenuAnchorRight = utilityClassName("right-0");
...
export const fileChipName = utilityClassName("truncate text-label text-fg");
export const fileChipSub = utilityClassName("text-meta text-faint");
