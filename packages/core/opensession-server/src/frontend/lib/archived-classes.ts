 ...
 */
export const ARCHIVED_LIST = utilityClassName("-mx-3");
...
export const ARCHIVED_SECTION_LABEL = utilityClassName(
  "m-0 px-3 pb-1.5 text-meta font-semibold text-faint",
);

export const ARCHIVED_SECTION_ROWS = utilityClassName("m-0 list-none p-0");
...
export const ARCHIVED_ROW =
  ...
  utilityClassName("hover:bg-hover focus-within:bg-hover ") +
  utilityClassName(
  ...
  utilityClassName("hover:after:opacity-0 focus-within:after:opacity-0 ") +
  utilityClassName(
...
export const ARCHIVED_ROW_OPEN =
  ...
  utilityClassName("text-left after:absolute after:inset-0 after:content-['']");

export const ARCHIVED_ROW_TITLE = utilityClassName(
...
export const ARCHIVED_ROW_META = utilityClassName(
...
export const ARCHIVED_ROW_TRAIL =
  ...
  utilityClassName("group-focus-within:opacity-0 phone:hidden");

export const ARCHIVED_ROW_TIME = utilityClassName(
...
export const ARCHIVED_ROW_ACTION =
  ...
  utilityClassName("focus-visible:opacity-100 phone:hidden");
