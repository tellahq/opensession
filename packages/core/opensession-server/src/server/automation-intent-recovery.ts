 ...
 * was clicked again and again while it failed) leaves one intent per
 * attempt: 2026-09-09 a broken repository ref left 20 pending intents for 9
 * tickets, 7 of them for one ticket. Replaying each would open one triage
 * session per attempt. Keep the earliest-accepted intent per (automation,
