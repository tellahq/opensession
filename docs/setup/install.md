...
| AWS runs (off by default) | `AGENT_AWS_CREDS`, `AGENT_AWS_REGION`, `AGENT_AWS_MINT_USER`, `AGENT_AWS_UNTRUSTED_RUNS`                                                                               | [integrations-misc.md](integrations-misc.md#aws-creds-for-runs-agent_aws_region)       |
