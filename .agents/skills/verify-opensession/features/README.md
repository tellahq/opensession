...
- [Databases](./databases.md) covers the database list, creation, detail routes, table and query views, and phone navigation.
- [Desk](./desk.md) covers opening the standing assistant, text controls, minimizing, full-session handoff, voice prerequisites, and phone layout.
