...
Keep a checklist whose first item is to read the Principles section of the canonical **pstack** skill. Then add the phases below as todos.
...
Then put the design into motion. Add its steps to the checklist as concrete items, after the Phase C entry and before Phase D. Run each under the Phase C loop discipline, and weave the Phase D log through them, a row as each step lands, rather than saving the whole trail for the end.
