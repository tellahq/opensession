...
- Confidence: candidate
- Skip when: Bugbot flags an export, component, helper, or file as unused, and the repository's documented stack view, upper-stack diffs, or PR context shows it is used by a later PR in the stack.
